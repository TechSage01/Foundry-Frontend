...
- *Backend:* https://github.com/TechSags01/Foundry-Backend
## What It Does
...
Idea 路 Planning 路 Building 路 Testing 路 Launching 路 Completed 路 Paused 路 Archived
### Profiles
Profiles focus on what a person has built rather than behaving like a traditional r茅sum茅.
Users can showcase:
- Skills
- Experience
- Projects
...
The goal is to show:
*Who built it 鈫� Why they built it 鈫� How it evolved 鈫� What they learned 鈫� Who contributed 鈫� Where it is going*
## Tech Stack
### Frontend
...
Backend repository:
https://github.com/TechSags01/Foundry-Backend
### Deployment
...
## Architecture
Foundry is split into a frontend application and a backend API.
text
...
## How It Was Made
Foundry was designed around a simple idea: *projects should be first-class objects rather than something hidden behind a user's r茅sum茅 or social profile.*
...
git clone https://github.com/TechSags01/Foundry-Backend.git
...
text
Foundry
鈹溾攢鈹� Foundry-Frontend
鈹�   鈹斺攢鈹� React / TypeScript application
鈹�
鈹斺攢鈹� Foundry-Backend
    鈹斺攢鈹� Node.js / Express / TypeScript API

## Product Principles
- *Builders first* 鈥� prioritize people who build things.
- *Projects are first-class citizens* 鈥� projects should drive identity and discovery.
- *Show the journey* 鈥� capture progress, decisions, milestones, setbacks, and launches.
